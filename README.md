...
I'm planning to use IPython notebooks to show the steps needed to arrive at a solution for the programming exercises.  To that end, I'm also adding some "intro" notebooks that include useful examples from the python language and tool stack.
